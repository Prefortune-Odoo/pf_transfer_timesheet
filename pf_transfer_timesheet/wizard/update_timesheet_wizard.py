...
class UpdateTimesheetWizard(models.TransientModel):
    ...
    def action_update_timesheet(self):
        ...
        # Filter out non-integer IDs (like sample data 'datapoint_x')
        ...
        # Update both project/task and the analytic account to ensure it shows up correctly in the new project
        write_vals = {
